...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " Có cái gì đấy ở bên trong này nè " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;hong có gì đâu';
document.querySelector('.Description .modal-body').innerHTML = 'EHHE :> <i class="fas fa-heart"></i> ';
